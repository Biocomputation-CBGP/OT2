def get_values(*names):
    import json
    _all_values = json.loads("""{"pip_model":"p20_single_gen2","pip_mount":"right","dp_type":"corning_96_wellplate_360ul_flat","dye_type":"opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap"}""")
